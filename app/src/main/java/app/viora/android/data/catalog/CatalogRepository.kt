...
object DemoCatalogRepository : CatalogRepository {
    private val catalog = listOf(
        MediaContent("world-border", "Граница миров", ContentType.SERIES, 2026, 8.1, setOf("Фантастика", "Драма"), "Испания", "1080p", 48, true, 95),
        MediaContent("quiet-signal", "Тихий сигнал", ContentType.MOVIE, 2025, 7.9, setOf("Триллер", "Драма"), "Франция", "1080p", 112, false, 91),
        MediaContent("last-flight", "Последний рейс", ContentType.MOVIE, 2026, 7.7, setOf("Триллер", "Приключения"), "Испания", "4K", 126, true, 88),
        ...
        MediaContent("zero-orbit", "Нулевая орбита", ContentType.SERIES, 2026, 8.3, setOf("Фантастика", "Триллер"), "США", "4K", 46, true, 99),
        MediaContent("return-point", "Точка возврата", ContentType.MOVIE, 2026, 7.8, setOf("Фантастика", "Триллер"), "Германия", "1080p", 116, true, 84),
        MediaContent("rain-city", "Город после дождя", ContentType.MOVIE, 2026, 8.0, setOf("Драма", "Комедия"), "Испания", "1080p", 102, true, 86),
        MediaContent("small-miracles", "Маленькие чудеса", ContentType.MOVIE, 2023, 7.4, setOf("Комедия", "Семейный"), "Испания", "720p", 94, false, 68),
