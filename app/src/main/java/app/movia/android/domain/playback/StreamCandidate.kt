...
data class StreamCandidate(
    ...
    val canonicalOriginalTitle: String? = null,
    ...
    fun toStreamOption(): StreamOption {
        return StreamOption(
            ...
            canonicalOriginalTitle = canonicalOriginalTitle,
    ...
    companion object {
        fun fromStreamOption(option: StreamOption, season: Int? = null, episode: Int? = null): StreamCandidate {
            ...
            return StreamCandidate(
                ...
                sourceTypeId = normalized.sourceTypeId,
                ...
                resolutionWidth = normalized.resolutionWidth,
                resolutionHeight = normalized.resolutionHeight,
                ...
                canonicalOriginalTitle = normalized.canonicalOriginalTitle,
