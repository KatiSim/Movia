...
internal fun buildMoviaPictureInPictureParams(
    ...
    builder.setActions(buildMoviaPictureInPictureActions(context, isPlaying))
...
private fun buildMoviaPictureInPictureActions(
    context: Context,
    isPlaying: Boolean,
): List<RemoteAction> {
    fun action(
        ...
        val intent = Intent(context, MoviaPiPActionReceiver::class.java)
